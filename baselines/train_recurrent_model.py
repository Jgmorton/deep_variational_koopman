...
import random
from utils import visualize_rnn_predictions, generate_rnn_predictions
...
def main():
    ...
    parser.add_argument('--save_dir',           type=str,   default='./rnn_checkpoints', help='directory to store checkpointed models')
    ...
    parser.add_argument('--save_name',          type= str,  default='rnn_model', help='name of checkpoint files for saving')
...
def train(args, net, env):
    ...
    with tf.Session() as sess:
        ...
        # generate_rnn_predictions(args, sess, net)
